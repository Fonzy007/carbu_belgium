"""Tests for Fuel Price in Belgium api."""
import asyncio

import aiohttp
from custom_components.carbu_belgium.api import (
    CarbuBelgiumApiClient,
)
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = CarbuBelgiumApiClient("test", "test", async_get_clientsession(hass))
